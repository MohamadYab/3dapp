...
$(document).ready(function() {
	...
	// TODO: Change/Update the active class to the active model!
	function selectPage() {
	...
	/** Function to CONTROL the Models Page content */
	// TODO: Change/Update the active class to the active model!
 ...
 * (The Restyle Button in the bottom nav) 
 */
function changeLook() {
	counter += 1;
	switch (counter) {
...
/** Function to Reset the look of the page 
 * (The Reset Button in the bottom nav) 
 */
function changeBack() {
